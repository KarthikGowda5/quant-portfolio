...
# Add repo root to sys.path so `scripts/` and `src/` are importable when running this file directly
...
PROJECT_DIR = Path(__file__).resolve().parents[1]          # .../project01_microstructure_alpha
PROJECT_REPORTS = PROJECT_DIR / "reports"
FIG_DIR = PROJECT_REPORTS / "figures" / "project1"
...
def main() -> None:
    ...
    sweep_path = PROJECT_REPORTS / "project1_latency_sweep.csv"
